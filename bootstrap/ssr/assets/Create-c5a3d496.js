...
function Create({ auth, page_data, message, ...props }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      Authenticated,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "container", children: /* @__PURE__ */ jsxs("div", { className: "w-full flex flex-col justify-center items-center", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl", children: "Add A User" }),
          ...
          /* @__PURE__ */ jsxs(
            "form",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "lg:max-w-[600px] w-full flex flex-col justify-center items-center mt-5", children: [
